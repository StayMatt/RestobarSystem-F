...
// Sección Caja: visible para Admin y Cajera
const CAJA_LINKS = [
...
export const Layout = () => {
    ...
    return (
        <div className="flex min-h-screen bg-slate-950">
            {/* Sidebar */}
            <aside className="w-64 bg-[#0f1117] fixed h-full flex flex-col border-r border-white/5 z-40">
                {/* Logo */}
